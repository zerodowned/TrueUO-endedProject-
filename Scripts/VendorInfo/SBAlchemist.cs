    ...
    public class SBAlchemist : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo(Mobile m)
            {
                ...
                Add(new GenericBuyInfo(typeof(Bottle), 5, 10, 0xF0E, 0, true));
                Add(new GenericBuyInfo(typeof(HeatingStand), 2, 10, 0x1849, 0));
                Add(new GenericBuyInfo(typeof(SkinTingeingTincture), 1255, 10, 0xEFF, 90));
                ...
                {
                    Add(new GenericBuyInfo(typeof(GlassblowingBook), 10637, 10, 0xFF4, 0));
                    Add(new GenericBuyInfo(typeof(SandMiningBook), 10637, 10, 0xFF4, 0));
                    Add(new GenericBuyInfo(typeof(Blowpipe), 21, 10, 0xE8A, 0x3B9));
                }
            }
        }
